...
metadata:
  author: fotingo
  version: "1.0.0"
  generatedBy: "0.0.0-SNAPSHOT-a5fdb93"
---
...
```bash
fotingo review -y --template-summary "Improve checkout decline handling" --template-description "Why: reduce support tickets from unclear payment errors. What: clearer decline copy, structured telemetry, and test coverage for decline scenarios."
```

Create with reviewers/assignees:

```bash
fotingo review -y -r alice -r team/platform --assignee bob
```
